...
const UserProfile = () => {
    ...
    const updateProfile = async (e) => {
        // console.log(e)
        const update = await axios.patch(`${process.env.REACT_APP_URL}/users/${username}`, data)
        console.log(update)
                    ...
                    <div className='h-[64vh] flex items-center justify-center sm:items-start sm:justify-start'>
                        <div className='pt-4 w-full flex flex-col justify-center items-center h-full'>
                            ...
                            <div className='flex flex-col items-center justify-center h-full gap-3 w-full sm:w-[40vw] m-auto'>
                                ...
                                <div className='p-4'>
                                    <button className='text-white bg-violet-500 font-bold px-4 py-2 w-auto rounded-md sm:text-lg' onClick={updateProfile}>Update Profile</button>
                                </div>
                            </div>
                        </div>
                    </div>
